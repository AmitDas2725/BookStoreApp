...
function Signup() {
  ...
  return (
    /* 🚨 CRITICAL FIX: This strict wrapper protects the page from flexbox glitches! */
    <div className="w-full relative">
        ...
        <div className="w-[85%] sm:w-[480px] border rounded-2xl shadow-2xl p-8 bg-white dark:bg-slate-900 dark:border-gray-700 relative">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex justify-between items-center pt-2">
              <button type="submit" className="bg-pink-500 text-white font-semibold rounded-lg px-6 py-2">
                Signup
              </button>
      ...
      {/* The Login component is safely inside the protective div wrapper now */}
      <Login />
    </div>
  );
}
